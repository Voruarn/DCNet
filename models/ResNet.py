...
if __name__=='__main__':
    ...
    model=eval(model_name)(pretrained=False).cuda()
    output=model(input)
...
model_name: resnet50
input.shape: torch.Size([2, 3, 512, 512])
out.shape: torch.Size([2, 256, 128, 128])
out.shape: torch.Size([2, 512, 64, 64])
out.shape: torch.Size([2, 1024, 32, 32])
out.shape: torch.Size([2, 2048, 16, 16])
